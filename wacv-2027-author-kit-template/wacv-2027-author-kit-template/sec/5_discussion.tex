...
\cref{app:rowbudget}. Sweeping the budget over a factor of three moves the improvement by less
than the confidence interval of any single setting, so the headline is not an artefact of the
subsample, but neither can we say what happens on the full dump.
